...
async def edit_metadata(listener, base_dir: str, media_file: str, outfile: str, metadata: str = ''):
    cmd = ['ffmpeg', '-hide_banner', '-ignore_unknown', '-i', media_file, '-metadata', f'title={metadata}',     '-metadata', f'author=HeartBeat',
    '-metadata', f'summary=Time Spent With Coding Is Never Wasted',
    '-metadata', f'description=Learn From Mistakes', '-metadata', f'encoded_by=HeartBeat',
    '-metadata', f'website=https://anjanmodak.me',
    '-metadata', f'comment=Connecting Film Lovers', '-metadata', f'copyright=Film District', '-metadata:s:v',
